...
/** @type { (kbUrl: string, name: string, inputIndex: string, actions: Array<{ id: string, group: string, params: any }>) => Promise<string> } */
async function createAlert(kbUrl, name, inputIndex, actions = []) {
  /** @type {any} */
  const data = {
    enabled: true,
    name,
