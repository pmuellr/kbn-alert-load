...
/** @type { (config: string, stack: string | undefined, date: Date, options: DeploymentOptions) => Promise<Deployment> } */
async function createDeployment(config, stack, date, options) {
