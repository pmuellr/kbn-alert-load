...
/** @type { (runName: string, scenario: Scenario, deployments: Deployment[], eventLog: EventLogRecord[], kbStatus: any[]) => void } */
function generateReport(runName, scenario, deployments, eventLog, kbStatus) {
  ...
  const content = readTemplate()
    ...
    .replace('["%KbStatus%"]', JSON.stringify(kbStatus, null, 4))
