  ...
  .reduce((scenarios, [scenarioName, tmStatsInScenario]) => {    
    ...
    scenarios[scenarioName] = Array.from(tmStatsInScenario.entries())
      .reduce((summary, [tmId, tmStats]) => {    
        // @ts-ignore
        summary[tmId] = tmStats.map(tmStat => {
          ...
          return ({
            ...
            stats: {
              ...
              runtime: {
                value: {
                  drift: {
                    p50: tmStat.stats.runtime.value.drift.p50,
                    p90: tmStat.stats.runtime.value.drift.p90
                  },
                  duration: hasAlertStats
                    ? {
                        p50: tmStat.stats.runtime.value.execution.duration["alerting:.index-threshold"].p50,
                        p90: tmStat.stats.runtime.value.execution.duration["alerting:.index-threshold"].p90
                    } : {},
                  ...
                  polling:  {
                    NoTasksClaimed: tmStat.stats.runtime.value.polling["result_frequency_percent_as_number"].NoTasksClaimed,
                    RanOutOfCapacity: tmStat.stats.runtime.value.polling["result_frequency_percent_as_number"].RanOutOfCapacity,
                    PoolFilled: tmStat.stats.runtime.value.polling["result_frequency_percent_as_number"].PoolFilled
                  },
                }
              },
              workload: {
